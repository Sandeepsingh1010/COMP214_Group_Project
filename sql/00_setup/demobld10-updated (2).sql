...
DROP SEQUENCE location_a_seq;
DROP SEQUENCE departments_seq;
DROP SEQUENCE employees_a_seq;

DROP TABLE countries_a CASCADE CONSTRAINTS;
DROP TABLE location_a CASCADE CONSTRAINTS;
DROP TABLE departments CASCADE CONSTRAINTS;
DROP TABLE employees_a   CASCADE CONSTRAINTS;
...
REM ********************************************************************
REM Create the countries_a table to hold country information for customers
REM and company location_a. 
REM location_a have a foreign key to this table.

Prompt ******  Creating countries_a table ....
...
REM ********************************************************************
REM Create the location_a table to hold address information for company departments.
...
Rem 	Useful for any subsequent addition of rows to location_a table
